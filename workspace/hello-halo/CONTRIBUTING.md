# Contributing to ATUM CREA

Thanks for your interest in contributing to ATUM CREA! This guide will help you get started.
...
1. `src/preload/index.ts` - Expose to `window.atumCrea`
...
```bash
# Fork and clone
git clone https://github.com/YOUR_USERNAME/atum-crea.git
cd atum-crea
npm install
...
- Check existing [Issues](https://github.com/atumcrea/atum-crea/issues)
- Create a new issue if needed
- Comment on the issue to let us know you're working on it

### 3. Development

💡 **Recommended**: Use **ATUM CREA + Claude Opus 4.5** for development!
...
ATUM CREA supports custom AI source providers through a plugin architecture. You can create your own OAuth or API key-based providers.
...
- Open a [GitHub Discussion](https://github.com/atumcrea/atum-crea/discussions)
- Check existing [Issues](https://github.com/atumcrea/atum-crea/issues)
