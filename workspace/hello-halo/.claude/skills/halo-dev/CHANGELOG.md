...
**Extension method**: Third-party Providers go in `atum-local/src/providers/`, dynamically loaded via `product.json`.
...
Control desktop ATUM CREA remotely via browser.
...
- Space management (ATUM CREA temporary space + Dedicated spaces)
