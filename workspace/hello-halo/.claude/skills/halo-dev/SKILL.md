---
name: ATUM CREA Development Context
description: Essential project context for AI developers working on ATUM CREA. Must read before writing any code.
---

# ATUM CREA Development Context
