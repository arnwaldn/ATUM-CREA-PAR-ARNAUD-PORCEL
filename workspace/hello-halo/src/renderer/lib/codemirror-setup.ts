 ...
 * - Theme integration with ATUM CREA's CSS variables
 *
...
import { atumTheme } from './codemirror-theme'
...
/**
 * Compartment for word wrap toggle
 */
...
/**
 * Create a new EditorState with ATUM CREA's default configuration
 */
export function createEditorState(options: CreateEditorStateOptions): EditorState {
  ...
  return EditorState.create({
    ...
    extensions: [
      ...
      wordWrapCompartment.of([]), // Default: no word wrap
      themeCompartment.of(atumTheme), // Always use atumTheme
...
/**
 * Toggle word wrap on an EditorView
 */
...
/**
 * Go to a specific line number in the editor
 */
