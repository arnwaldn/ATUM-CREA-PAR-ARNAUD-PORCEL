...
const GUIDE_STATE_KEY = 'atum-space-guide-expanded'
    ...
    <div className="mb-6 animate-fade-in">
      ...
      {isExpanded && (
        <div className="mt-2 rounded-lg bg-card border border-border overflow-hidden animate-slide-down">
            ...
            <div className="flex items-start gap-2.5 sm:gap-3">
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="text-xs sm:text-sm text-muted-foreground leading-relaxed space-y-0.5 sm:space-y-1">
                  <p>{t('ATUM CREA is not just chat, it can help you do things')}</p>
          ...
          <div className="px-3 py-2.5 sm:p-3 bg-atum-warning/5 border-t border-border/50">
            <div className="flex items-center gap-2">
              <AlertTriangle className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-atum-warning flex-shrink-0" />
              <p className="text-xs text-muted-foreground">
                <span className="text-atum-warning font-medium">{t('AI has delete permissions')}</span>
