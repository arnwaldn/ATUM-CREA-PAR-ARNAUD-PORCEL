  ...
  return (
    ...
    `}>
      ...
      {displayMessages.map((message, index) => {
        ...
        const isLastAssistant = !isGenerating && message.role === 'assistant' &&
          ...
          return (
            <div key={message.id} className="flex justify-start group">
              ...
              <div className="w-[85%]">
                ...
                <MessageItem message={message} previousCost={previousCost} hideThoughts isInContainer {...actionProps} />
              </div>
            </div>
          )
        }
        return <MessageItem key={message.id} message={message} previousCost={previousCost} {...actionProps} />
      })}
