...
import { api } from '../api'
import type { AtumCreConfig, McpServersConfig } from '../types'
...
export function SettingsPage() {
  ...
  const handleMcpServersSave = async (servers: McpServersConfig) => {
    ...
    setConfig({ ...config, mcpServers: servers } as AtumCreConfig)
  }
          ...
          <div className="p-6">
            <div className="max-w-2xl mx-auto space-y-6">
              ...
              <section id="ai-model" className="bg-card rounded-xl border border-border p-6">
                ...
                <AISourcesSection config={config as AtumCreConfig} setConfig={setConfig} />
              </section>
