 ...
 *
 * This module provides AI-controlled browser capabilities for ATUM CREA.
...
You can now control ATUM CREA's embedded real browser. All browser tools are provided via MCP server "ai-browser".
