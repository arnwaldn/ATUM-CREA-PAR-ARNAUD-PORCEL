/**
 * ATUM CREA Auto-Updater Service
 *
 * STATUS: DISABLED
 * The auto-update system is temporarily disabled while ATUM CREA is in active development.
 * A custom update system will be implemented once the product reaches stable release.
 *
 * Original capabilities (preserved for future re-activation):
 ...
 * - Manual check: User-triggered from Settings or menu
 */
...
export function initAutoUpdater(): void {
  // AUTO-UPDATE DISABLED: ATUM CREA is in active development
  // Will be re-enabled with a custom update system when stable
  console.log('[Updater] Auto-update disabled during ATUM CREA development phase')
  return
...
export async function autoCheckForUpdates(): Promise<void> {
  // AUTO-UPDATE DISABLED during ATUM CREA development
  console.log('[Updater] Auto-update check disabled during development phase')
  return
}
...
export async function manualCheckForUpdates(): Promise<void> {
  // AUTO-UPDATE DISABLED during ATUM CREA development
  console.log('[Updater] Manual update check disabled during development phase')
