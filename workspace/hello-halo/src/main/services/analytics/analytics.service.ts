 ...
 */
declare const __ATUM_GA_MEASUREMENT_ID__: string
declare const __ATUM_GA_API_SECRET__: string
declare const __ATUM_BAIDU_SITE_ID__: string
...
const PROVIDER_CONFIG = {
  baidu: {
    siteId: __ATUM_BAIDU_SITE_ID__
  },
  ga: {
    measurementId: __ATUM_GA_MEASUREMENT_ID__,
    apiSecret: __ATUM_GA_API_SECRET__
  }
}
