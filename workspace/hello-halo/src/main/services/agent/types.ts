...
export interface AgentRequest {
  ...
  thinkingEnabled?: boolean   // Enable extended thinking mode (maxThinkingTokens: 32000)
  model?: string              // Model to use (for future model switching)
  canvasContext?: CanvasContext  // Current canvas state for AI awareness
  workingDirOverride?: string   // Override working directory for this request
}
...
export interface SessionConfig {
  ...
  workDir?: string  // Working directory override — rebuild needed when changed
