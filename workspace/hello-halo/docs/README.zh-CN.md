...
无需接触终端，即可体验 AI Agent 的全部能力。ATUM CREA 为所有人带来可视化、跨平台的桌面体验 — 开源且免费。
...
> **ATUM CREA** 把 Claude Code CLI 变成了可视化 AI 伙伴。
...
### 真正的 Agent 循环
不只是聊天。ATUM CREA 能**真正做事** — 写代码、创建文件、执行命令，持续迭代直到任务完成。
...
### 远程访问
从手机或任何浏览器控制你的桌面 ATUM CREA。随时随地工作 — 甚至在医院病床上（真实故事）。
...
| 平台 | 下载 | 要求 |
|----------|----------|--------------|
| **macOS** (Apple Silicon) | [下载 .dmg](https://github.com/atumcrea/atum-crea/releases/latest) | macOS 11+ |
| **macOS** (Intel) | [下载 .dmg](https://github.com/atumcrea/atum-crea/releases/latest) | macOS 11+ |
| **Windows** | [下载 .exe](https://github.com/atumcrea/atum-crea/releases/latest) | Windows 10+ |
| **Linux** | [下载 .AppImage](https://github.com/atumcrea/atum-crea/releases/latest) | Ubuntu 20.04+ |
...
1. **启动 ATUM CREA** 并输入你的 API 密钥（推荐 Anthropic）
...
障碍不再是 AI 的能力，**而是可及性**。ATUM CREA 消除了这个障碍。
...
ATUM CREA 开源是因为 AI 应该人人可及。

我们欢迎各种贡献：

- **翻译** — 帮助我们触达更多用户（见 `src/renderer/i18n/`）
- **Bug 报告** — 发现问题？告诉我们
- **功能建议** — 什么能让 ATUM CREA 更好用？
- **代码贡献** — 欢迎 PR！
...
- [GitHub Discussions](https://github.com/atumcrea/atum-crea/discussions) — 问题与想法
- [Issues](https://github.com/atumcrea/atum-crea/issues) — Bug 报告与功能请求
...
<p align="center">
  <em>如二维码过期，可加微信：helloddbb<strong>_</strong>（注意末尾有下划线，昵称"混沌数字"），备注"ATUM CREA"，将邀请入群</em>
</p>
...
所以我为自己和朋友做了 ATUM CREA：
- **可视化界面** — 不用再盯着终端输出
- **一键安装** — 不需要 Node.js，不需要 npm，下载即用
- **远程访问** — 从手机、平板或任何浏览器控制

第一版只用了几个小时。之后的所有功能？**100% 由 ATUM CREA 自己构建。** 我们已经日常使用好几个月了。
...
如果 ATUM CREA 帮你创造了精彩的东西，我们很想听听。

**Star 这个仓库** 帮助更多人发现 ATUM CREA。
