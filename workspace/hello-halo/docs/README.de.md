...
Erlebe die volle Kraft eines AI Agents, ohne das Terminal zu berühren. ATUM CREA bietet allen eine visuelle, plattformübergreifende Desktop-Erfahrung—open source und kostenlos.
...
**ATUM CREA überwindet diese Hürde.**
...
> **ATUM CREA** verwandelt Claude Code CLI in einen visuellen KI-Begleiter.
...
### Echter Agent-Loop
Nicht nur Chat. ATUM CREA kann **wirklich Dinge tun** — Code schreiben, Dateien erstellen, Befehle ausführen und iterieren, bis die Aufgabe erledigt ist.
...
### Fernzugriff
Steuere dein Desktop-ATUM CREA von deinem Handy oder jedem Browser. Arbeite von überall — sogar von einem Krankenhausbett (wahre Geschichte).
...
*Fernzugriff: Steuere ATUM CREA von überall*
...
|----------|----------|--------------|
| **macOS** (Apple Silicon) | [Download .dmg](https://github.com/atumcrea/atum-crea/releases/latest) | macOS 11+ |
| **macOS** (Intel) | [Download .dmg](https://github.com/atumcrea/atum-crea/releases/latest) | macOS 11+ |
| **Windows** | [Download .exe](https://github.com/atumcrea/atum-crea/releases/latest) | Windows 10+ |
| **Linux** | [Download .AppImage](https://github.com/atumcrea/atum-crea/releases/latest) | Ubuntu 20.04+ |
...
1. **Starte ATUM CREA** und gib deinen API-Schlüssel ein (Anthropic empfohlen)
...
ATUM CREA ist nicht nur für Entwickler. Wir haben gesehen:
...
Die Hürde ist nicht mehr die KI-Fähigkeit. **Es ist die Zugänglichkeit.** ATUM CREA beseitigt diese Hürde.
...
ATUM CREA ist Open Source, weil KI für alle zugänglich sein sollte.
...
- **Feature-Ideen** — Was würde ATUM CREA für dich besser machen?
...
- [GitHub Discussions](https://github.com/atumcrea/atum-crea/discussions) — Fragen & Ideen
- [Issues](https://github.com/atumcrea/atum-crea/issues) — Bug-Reports & Feature-Anfragen
...
## Die Geschichte Hinter ATUM CREA
...
Also baute ich ATUM CREA für mich und meine Freunde:
...
Die erste Version dauerte ein paar Stunden. Alles danach? **100% von ATUM CREA selbst gebaut.** Wir nutzen es seit Monaten täglich.
...
Wenn ATUM CREA dir hilft, etwas Großartiges zu bauen, würden wir gerne davon hören.

**Gib diesem Repo einen Star** um anderen zu helfen, ATUM CREA zu entdecken.
