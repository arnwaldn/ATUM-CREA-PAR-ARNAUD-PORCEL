...
ターミナルに触れることなく、AI Agent の全機能を体験できます。ATUM CREA は、ビジュアルでクロスプラットフォームなデスクトップ体験をすべての人に提供します—オープンソースで無料。
...
> **ATUM CREA** は Claude Code CLI をビジュアル AI コンパニオンに変えます。
...
### 本物の Agent ループ
チャットだけではありません。ATUM CREA は **実際に行動できます** — コードを書き、ファイルを作成し、コマンドを実行し、タスクが完了するまで反復します。
...
### リモートアクセス
スマートフォンや任意のブラウザからデスクトップの ATUM CREA を制御。どこからでも作業 — 病院のベッドからでも（実話）。
...
| プラットフォーム | ダウンロード | 要件 |
|----------|----------|--------------|
| **macOS** (Apple Silicon) | [.dmg をダウンロード](https://github.com/atumcrea/atum-crea/releases/latest) | macOS 11+ |
| **macOS** (Intel) | [.dmg をダウンロード](https://github.com/atumcrea/atum-crea/releases/latest) | macOS 11+ |
| **Windows** | [.exe をダウンロード](https://github.com/atumcrea/atum-crea/releases/latest) | Windows 10+ |
| **Linux** | [.AppImage をダウンロード](https://github.com/atumcrea/atum-crea/releases/latest) | Ubuntu 20.04+ |
...
1. **ATUM CREA を起動** して API キーを入力（Anthropic 推奨）
...
ATUM CREA は開発者だけのものではありません。私たちが見てきたもの：
...
障壁はもはや AI の能力ではありません。**アクセシビリティです。** ATUM CREA はその障壁を取り除きます。
...
- [GitHub Discussions](https://github.com/atumcrea/atum-crea/discussions) — 質問＆アイデア
- [Issues](https://github.com/atumcrea/atum-crea/issues) — バグレポート＆機能リクエスト
...
ATUM CREA が素晴らしいものを作る手助けになったら、ぜひ聞かせてください。

**このリポジトリに Star を** して、他の人が ATUM CREA を発見する手助けをしてください。
