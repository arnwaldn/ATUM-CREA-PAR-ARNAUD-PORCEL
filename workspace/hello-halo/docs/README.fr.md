...
Expérimentez toute la puissance d'un AI Agent sans toucher au terminal. ATUM CREA apporte une expérience de bureau visuelle et multiplateforme à tous—open source et gratuit.
...
> **ATUM CREA** transforme Claude Code CLI en compagnon IA visuel.
...
Pas seulement du chat. ATUM CREA peut **vraiment faire des choses** — écrire du code, créer des fichiers, exécuter des commandes, et itérer jusqu'à ce que la tâche soit terminée.
...
### Accès Distant
Contrôlez votre ATUM CREA de bureau depuis votre téléphone ou n'importe quel navigateur. Travaillez de n'importe où — même depuis un lit d'hôpital (histoire vraie).
...
*Accès Distant : Contrôlez ATUM CREA de n'importe où*
...
|----------|----------|--------------|
| **macOS** (Apple Silicon) | [Télécharger .dmg](https://github.com/atumcrea/atum-crea/releases/latest) | macOS 11+ |
| **macOS** (Intel) | [Télécharger .dmg](https://github.com/atumcrea/atum-crea/releases/latest) | macOS 11+ |
| **Windows** | [Télécharger .exe](https://github.com/atumcrea/atum-crea/releases/latest) | Windows 10+ |
| **Linux** | [Télécharger .AppImage](https://github.com/atumcrea/atum-crea/releases/latest) | Ubuntu 20.04+ |
...
1. **Lancez ATUM CREA** et entrez votre clé API (Anthropic recommandé)
...
ATUM CREA n'est pas que pour les développeurs. Nous avons vu :
...
L'obstacle n'est plus la capacité de l'IA. **C'est l'accessibilité.** ATUM CREA supprime cet obstacle.
...
ATUM CREA est open source parce que l'IA devrait être accessible à tous.
...
- **Idées de fonctionnalités** — Qu'est-ce qui rendrait ATUM CREA meilleur pour vous ?
...
- [GitHub Discussions](https://github.com/atumcrea/atum-crea/discussions) — Questions et idées
- [Issues](https://github.com/atumcrea/atum-crea/issues) — Rapports de bugs et demandes de fonctionnalités
...
Alors j'ai construit ATUM CREA pour moi et mes amis :
...
La première version a pris quelques heures. Tout après ça ? **100% construit par ATUM CREA lui-même.** On l'utilise quotidiennement depuis des mois.
...
Si ATUM CREA vous aide à construire quelque chose d'incroyable, on aimerait en entendre parler.

**Donnez une Star à ce repo** pour aider les autres à découvrir ATUM CREA.
