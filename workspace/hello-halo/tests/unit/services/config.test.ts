...
describe('Config Service', () => {
  describe('getAtumCreDir', () => {
    it('should return path to app data directory in home', () => {
      const appDir = getAtumCreDir()
      expect(appDir).toContain('.atum')
    })
  })
  ...
  describe('getConfigPath', () => {
    it('should return path to config.json', () => {
      ...
      expect(configPath).toContain('.atum')
    })
  })
  ...
  describe('initializeApp', () => {
    it('should create necessary directories', async () => {
      ...
      expect(fs.existsSync(path.join(appDir, 'temp'))).toBe(true)
      expect(fs.existsSync(path.join(appDir, 'spaces'))).toBe(true)
    })
