 ...
 *
 * Configures Playwright to test the ATUM CREA Electron application.
...
function getAppPath(): string {
  ...
  if (platform === 'darwin') {
    ...
    return path.join(projectRoot, 'dist/win-unpacked/ATUM CREA.exe')
  } else {
    // Linux
    return path.join(projectRoot, 'dist/linux-unpacked/atum-crea')
  }
}
