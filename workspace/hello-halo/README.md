...
Experience the full power of an AI Agent without touching the terminal. ATUM CREA brings a visual, cross-platform desktop experience to everyone—open source and free.
...
**ATUM CREA breaks down that wall.**
...
> **ATUM CREA** turns Claude Code CLI into a visual AI companion.
...
### Real Agent Loop
Not just chat. ATUM CREA can **actually do things** — write code, create files, run commands, and iterate until the task is done.
...
### Remote Access
Control your desktop ATUM CREA from your phone or any browser. Work from anywhere — even from a hospital bed (true story).
...
*Remote Access: Control ATUM CREA from anywhere*
...
1. **Launch ATUM CREA** and enter your API key (Anthropic recommended)
...
ATUM CREA isn't just for developers. We've seen:
...
The barrier isn't AI capability anymore. **It's accessibility.** ATUM CREA removes that barrier.
...
ATUM CREA is open source because AI should be accessible to everyone.

We welcome contributions of all kinds:

- **Translations** — Help us reach more users (see `src/renderer/i18n/`)
- **Bug reports** — Found something broken? Let us know
- **Feature ideas** — What would make ATUM CREA better for you?
...
- [GitHub Discussions](https://github.com/atumcrea/atum-crea/discussions) — Questions & ideas
- [Issues](https://github.com/atumcrea/atum-crea/issues) — Bug reports & feature requests
...
So I built ATUM CREA for myself and my friends:
...
The first version took a few hours. Everything after that? **100% built by ATUM CREA itself.** We've been using it daily for months.
...
If ATUM CREA helps you build something amazing, we'd love to hear about it.

**Star this repo** to help others discover ATUM CREA.
